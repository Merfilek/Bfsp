...
const blendingEffectRows = document.querySelectorAll("#blendingModal .blending-effect-row");
const blendingEffectPanels = document.querySelectorAll("#blendingModal .blending-effect-panel");
